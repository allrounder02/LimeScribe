...
UI_ICON_FILES: dict[str, str] = {
    ...
    "tts_open_saved_audio": "tts_open_saved_audio.png",
    "dialogue_send": "dialogue_send.png",
    "dialogue_reset": "dialogue_reset.png",
...
UI_ICON_FALLBACKS: dict[str, QStyle.StandardPixmap] = {
    ...
    "tab_dialogue": QStyle.StandardPixmap.SP_MessageBoxInformation,
    ...
    "tts_open_saved_audio": QStyle.StandardPixmap.SP_DirOpenIcon,
    "dialogue_send": QStyle.StandardPixmap.SP_ArrowForward,
    "dialogue_reset": QStyle.StandardPixmap.SP_BrowserReload,
